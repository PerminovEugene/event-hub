...
var GqlLoginGuard = /** @class */ (function (_super) {
    __extends(GqlLoginGuard, _super);
    function GqlLoginGuard() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GqlLoginGuard.prototype.canActivate = function (context) {
    ...
    GqlLoginGuard.prototype.getRequest = function (context) {
    ...
    GqlLoginGuard.prototype.getResponse = function (context) {
        var ctx = graphql_1.GqlExecutionContext.create(context);
        /*
    ...
    GqlLoginGuard = __decorate([
        common_1.Injectable()
    ], GqlLoginGuard);
    return GqlLoginGuard;
}(passport_1.AuthGuard('local')));
exports.GqlLoginGuard = GqlLoginGuard;
