...
var GqlAuthenticatedGuard = /** @class */ (function () {
    function GqlAuthenticatedGuard() {
    }
    GqlAuthenticatedGuard.prototype.canActivate = function (context) {
    ...
    GqlAuthenticatedGuard.prototype.getRequest = function (context) {
